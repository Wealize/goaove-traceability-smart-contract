...
export interface AssetTraceabilityInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "approve"
...
export interface AssetTraceability extends BaseContract {
  connect(runner?: ContractRunner | null): AssetTraceability;
  waitForDeployment(): Promise<this>;

  interface: AssetTraceabilityInterface;
